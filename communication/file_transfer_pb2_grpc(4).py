...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in file_transfer_pb2_grpc.py depends on'
...
def add_FileTransferServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('filetransfer.FileTransferService', rpc_method_handlers)
